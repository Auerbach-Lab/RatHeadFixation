...
**Torx-plus bit (size IP5) & driver** -- Socket head screws are driven using a torx+ bit, e.g. [McMaster #54305A18](https://www.mcmaster.com/54305A18/). A mini ratcheting 1/4" shank driver e.g. [McMaster #52815A22](https://www.mcmaster.com/52815A22/) is appropriate for these bits. Torx-plus was chosen for its superior torque application given the extremely small size of the screws, and for its ability to easily 'grab' a screw simply by mating.
